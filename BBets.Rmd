...
hist(saveBank)
```
They expect to make an average of `r mean(saveBank)`
...
To make the game fair, Dr.Brownlow should pay out `r mean(saveBank)` The 95% confidence interval is (`r LCL`,`r UCL`)
...
sd(saveBank)
```
  to make the game fair, he should make the odds 1 : `r odds`
  
<!--Explain and display your method of coming up with a 95% confidence interval of  professor Brownlows winnings (or losings)-->

when 40 substutues do this method, the mean is -14(earnings). Our standatd deviation is 36.57
...
The numClass would be 28.3 to get the earnings down to -14 witch is the closest number to 0 i can get giving fair odds
